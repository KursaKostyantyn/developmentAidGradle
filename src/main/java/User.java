...
public class User {
    ...
    public User(int answer_count, int question_count, int reputation, String location, String link, String profile_image, String display_name, List<CollectiveMemberships> collectives) {
        this.answer_count = answer_count;
        this.question_count = question_count;
        this.reputation = reputation;
        this.location = location;
    ...
    public String toString() {
        return "User{" +
                ...
                ", Link to avatar='" + profile_image + '\'' +
                ", User name='" + display_name + '\'' +
                ", Tags=" + collectives.get(0).getCollective().getTags().toString() +
                '}';
    }
}
